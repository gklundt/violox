...
var VioEnforceLgComponent = /** @class */ (function () {
    function VioEnforceLgComponent(x) {
        this.x = x;
        this._modal = x.getSmallModal();
    }
    VioEnforceLgComponent.prototype.openModal = function () {
        this._modal.showModal = true;
        this._modal.showVideo = true;
    };
    VioEnforceLgComponent = __decorate([
        core_1.Component({
    ...
    return VioEnforceLgComponent;
}());
exports.VioEnforceLgComponent = VioEnforceLgComponent;
//# sourceMappingURL=vio-enforce-lg.component.js.map